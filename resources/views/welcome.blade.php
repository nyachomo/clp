                ...
                <div class="col-lg-6">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    ...
                                    <img src="{{asset('frontend/images/slider/slider1.jpg')}}" class="d-block w-100" alt="..." height="420">
                                    </div>
                                    <div class="carousel-item">
                                    <img src="{{asset('frontend/images/slider/slider2.jpg')}}" class="d-block w-100" alt="..." height="420">
                                    </div>
                                    <div class="carousel-item">
