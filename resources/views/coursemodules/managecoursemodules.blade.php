                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <textarea class="textarea1"><?php echo$module->module_content?></textarea>
                                                                    ...
                                                                    <div class="box">
                                                                            ...
                                                                            <div class="box-body pad">
                                                                                    ...
                                                                                    <textarea class="textarea" placeholder="Place some text here"
                                                                                            style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo$module->module_content?></textarea>
