    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                Total Suspended Clases: <span id="total-users">0</span>
                <!--<button type="button" data-bs-toggle="modal" data-bs-target="#suspendedClassesModal" class="btn btn-sm btn-warning rounded-pill" style="float:right"><span id="suspendedClasesButton"></span> Suspended Clases</button>-->
...
<div id="suspendClasModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel"> Are You sure you want to suspend this class ?</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
...
<div id="activateClasModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="standard-modalLabel"> Are You sure you want to activate this class ?</h4>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-hidden="true"></button>
            </div>
            <form method="POST" id="activateClasForm">
                ...
                <div class="card-body" style="border:1px solid white">
                    <input type="text" class="form-control" name="activate_clas_id" id="activate_clas_id" hidden="true">
...
<!-- Add User modal -->
<div id="suspendedClassesModal" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
...
function fetchUsers(page = 1, search = '', perPage = 10) {
    $.ajax({
        type: 'GET',
        url: "{{route('fetchSuspendedClases')}}",
                        ...
                        <td>\
                            <div class="dropdown">\
                                ...
                                <ul class="dropdown-menu">\
                                    ...
                                    <li><a class="dropdown-item deleteBtn text-danger" href="#" data-id="' + item.id + '"></a></li>' +
