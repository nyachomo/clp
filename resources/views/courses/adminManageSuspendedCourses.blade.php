    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                Total Suspended Courses: <span id="suspended">0</span>
               ...
               <a href="{{route('showCourses')}}" type="button" style="float:right" class="btn btn-sm btn-success rounded-pill"> <span id="active_courses"></span>Active Courses (View)</a>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                             <div class="form-group">
                                 ...
                                 <input type="file" name="course_image" class="form-control" hidden="true">
                             </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="course_name" required hidden="true">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <select name="course_level" class="form-control" required hidden="true">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="course_price" required min="1" hidden="true">
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="course_duration" required hidden="true">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                               ...
                               <select name="is_scholarship_test_course" class="form-control" required hidden="true">
                                  <option value="">Select ....</option>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <label>Course Description</label>
                                ...
                                <textarea  class="form-control" name="course_description" col="6" hidden="true"> </textarea>
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                       ...
                       <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <!--<label>Course Name<sup>*</sup></label>-->
                                <input type="text" class="form-control" name="course_name" id="course_name" required hidden="true">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <!--<label>Level<sup>*</sup></label>-->
                                <select name="course_level" id="course_level" class="form-control" required hidden="true">
                                    <option value="">Select ..</option>
                                    <option value="Basic Level">Basic Level</option>
                                    <option value="Intermediary Level">Intermediary Level</option>
                                    <option value="Advance Level">Advance Level</option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <!--<label>Course Duration (In Weeks)<sup>*</sup></label>-->
                                <input type="number" class="form-control" name="course_duration" id="course_duration" required hidden="true">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <!--<label>Course Price (Ksh)<sup>*</sup></label>-->
                                <input type="number" class="form-control" name="course_price"  id="course_price" required min="1" hidden="true">
                            </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <!--<label>Is Scholarship Test Course</label>-->
                                    <select name="is_scholarship_test_course" class="form-control" id="is_scholarship_test_course" required hidden="true">
                                        <option value="">Select ....</option>
                                        <option value="Yes">Yes</option>
                                        <option value="No">No</option>
                                    </select>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                                ...
                                <textarea  class="form-control" name="course_description" id ="course_description" col="6" hidden="true"> </textarea>
...
function fetchUsers(page = 1, search = '', perPage = 10) {
    $.ajax({
        type: 'GET',
        url: "{{route('fetchSuspendedCourses')}}",
