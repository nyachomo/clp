    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                ...
                <a type="button" style="float:right" class="btn btn-sm btn-success rounded-pill" data-bs-toggle="modal" data-bs-target="#addCourseModal"> <i class="uil-user-plus"></i>Add</a>
            </div>
            <div class="card-body">
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('.deleteBtn').on('click', function() {
                const delete_course_id = $(this).val();
                // Populate modal fields
            ...
            $('.suspendBtn').on('click', function() {
                const suspend_course_id = $(this).val();
                // Populate modal fields
