                        ...
                        <div id="updateModule{{ $module->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('teacherUpdateModule') }}" class="js-module-form">
                                        @csrf
                                        <div class="card-body">
                        ...
                        <div id="deleteModule{{ $module->id }}" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form method="POST" action="{{ route('teacherDeleteModule') }}" class="js-module-form">
                                        @csrf
...
<div id="addModuleModal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <form method="POST" action="{{ route('teacherAddModule') }}" class="js-module-form">
                @csrf
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12">
