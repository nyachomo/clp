...
<head>
     ...
     <link href="https://fonts.googleapis.com/css2?family=Afacad+Flux:wght@100..1000&display=swap" rel="stylesheet">
        ...
        <script src="https://cdn.tiny.cloud/1/krfz17eg92fzkqudwvql9jzu1xevin49e4qwz97unmaccw2m/tinymce/8/tinymce.min.js" referrerpolicy="origin" crossorigin="anonymous"></script>
  ...
  #pagination-controls .active {
    ...
    <body class="loading" data-layout-color="light" data-leftbar-theme="dark" data-layout-mode="fluid" data-rightbar-onstart="true">
       ...
       <!-- <script src="{{asset('admin2/bower_components/fastclick/lib/fastclick.js')}}"></script>-->
        ...
        <!-- CK Editor -->
        <script src="{{asset('admin2/bower_components/ckeditor/ckeditor.js')}}"></script>
        <!-- Bootstrap WYSIHTML5 -->
